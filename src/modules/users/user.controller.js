...
export const signUp = asyncHandler(async (req, res, next) => {
    ...
    const token = jwt.sign({ email }, process.env.signature, { expiresIn: 30 })
    ...
    await sendEmail(email, "verify your email", `<a href="${link}">click here to confirm email</a> 
        <br><a href="${rfLink}">reSend link</a>`)
